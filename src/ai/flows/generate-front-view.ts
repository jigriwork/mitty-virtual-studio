...
const generateFrontViewFlow = ai.defineFlow(
  ...
  async (input) => {
    ...
    const promptText = `Generate a photorealistic front view of a ${gender} model standing straight in a studio setup. He is wearing a ${productDescription} for ${forGender} ${colorPattern}, accurately reflecting the style and print of the uploaded product image.
