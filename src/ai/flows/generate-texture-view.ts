...
import {
  ...
  buildTaglessTrouserTextureInstruction,
  buildTrouserAccuracyInstructions,
...
The final image color MUST be ${input.color}. Preserve the weave, texture, fiber appearance, grain, and finish from the uploaded fabric close-up reference. In manual colour mode, do not use the uploaded fabric lighting or reference photo colour to override ${input.color}. No alterations, smoothing, invented pattern, invented logo, or garment construction details. Use soft, even, diffuse studio lighting and a clean background to keep the texture natural and realistic. Final output must be pin-sharp, high-detail, HD quality suitable for a premium e-commerce product page.

${buildTaglessTrouserTextureInstruction(input)}
